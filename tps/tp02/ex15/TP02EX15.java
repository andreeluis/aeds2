...
class SelectionSort {
  ...
  public SelectionSort(Personagem[] array, int tam) {
    this.array = array;
    this.tam = tam;
    this.k = tam;
  }

  public SelectionSort(Personagem[] array, int tam, int k) {
    this.array = array;
    this.tam = tam;
    this.k = k;
  }
...
public class TP02EX15 {
  public static void main(String[] args) {
    ...
    SelectionSort selectionSort = new SelectionSort(personOrd, tam, 10);
    selectionSort.sort();
