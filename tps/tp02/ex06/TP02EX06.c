...
void selectionSortRecursivo(Personagem personagens[], int n, int i)
{
  if (i < n)
  {
    int menor = i;
    ...
    selectionSortRecursivo(personagens, n, i + 1);
  }
}

void selectionSort(Personagem personagens[], int n)
{
  selectionSortRecursivo(personagens, n, 0);
}
...
int main()
{
  ...
  selectionSort(pSelecionados, tam);
