...
public class TP03EX06{
  ...
  public static void main(String[] args) {
    ...
    Pilha personagensPilha = new Pilha();

    String id = scanner.nextLine();
    while (!id.equals("FIM")) {
      personagensPilha.inserir(findPersonagem(id));
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (op.equals("I")) {
        ...
        System.out.println("(R) " + personagensPilha.remover().getName());
      }
    }

    personagensPilha.imprimir();
